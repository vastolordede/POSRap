...
public class BapNuocDAO extends BaseDAO {
    ...
    /* ================== HÓA ĐƠN (Đã dọn dẹp hàm Tồn Kho) ================== */
    ...
    public HoaDonBapNuocDTO taoHoaDon(List<ChiTietHoaDonBapNuocDTO> ct) throws Exception {
        ...
        try {
            ...
            // Dùng NOW() cho PostgreSQL/MySQL, nếu dùng SQL Server của Microsoft thì đổi NOW() thành GETDATE()
            String sqlHD =
            ...
            // Lưu chi tiết hóa đơn cực nhanh (không tính toán tồn kho)
